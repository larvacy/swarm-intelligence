...
import math
import time
from fitness_functions import f1_fitness
...
class Swarm:
    ...
    def swarm_init(self, search_domain):
        ...
        self.best_fitness = f1_fitness(self.position)  # 计算适应值
    ...
    def train(self, w, c1, c2, max_iter):
        ...
        for i in range(max_iter):
            print(f"begin {i+1}-th round of training...")
            # 更新位置和速度
            ...
            current_fitness = f1_fitness(current_p)  # 计算适应值
            ...
            print("current time consumption:", time.time() - start)
            print()
